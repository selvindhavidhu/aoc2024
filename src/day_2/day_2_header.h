#ifndef SELVIN_AOC2024_DAY_2_HEADER_H_INCLUDED
#define SELVIN_AOC2024_DAY_2_HEADER_H_INCLUDED
...
* level from unsafe reports.
* How many reports are now safe?
*/
int solve_day_2_part_2(const char* input_file_path);

#endif	// !SELVIN_AOC2024_DAY_2_HEADER_H_INCLUDED