#ifndef SELVIN_AOC2024_DAY_1_HEADER_H_INCLUDED
#define SELVIN_AOC2024_DAY_1_HEADER_H_INCLUDED
...
* The last number, 3, appears in the right list three times; the similarity score increases by 9.
...
#endif // !SELVIN_AOC2024_DAY_1_HEADER_H_INCLUDED
