#ifndef SELVIN_AOC2024_DAY_4_HEADER_H_INCLUDED
#define SELVIN_AOC2024_DAY_4_HEADER_H_INCLUDED
 ...
 * puzzle input) is corrupted. All the instructions have been jumbled up!
 *
 ...
 *
 * Handle the new instructions; what do you get if you add up all the results
 * of just the enabled multiplications?
 *
 * Your puzzle answer was 71668682.
*/
long long solve_day_4_part_2(const char* input_file_path);

#endif	// !SELVIN_AOC2024_DAY_4_HEADER_H_INCLUDED
